...
// sin*10000
const int sine_array[200] = {0, 79, 158, 237, 316, 395, 473, 552, 631, 710, 789, 867, 946, 1024, 1103, 1181, 1260, 1338,
...
float _sin(float a) {
    if (a < _PI_2) {
        return 0.0001f * (float) sine_array[_round(126.6873f * a)];
    } else if (a < _PI) {
        return 0.0001f * (float) sine_array[398 - _round(126.6873f * a)];
    } else if (a < _3PI_2) {
        return -0.0001f * (float) sine_array[-398 + _round(126.6873f * a)];
    } else {
        return -0.0001f * (float) sine_array[796 - _round(126.6873f * a)];
    }
}
